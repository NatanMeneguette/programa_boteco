    ...
    public partial class FormVenda : Form
    {
        ...
        private void btnAtualizarPedido_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow dr in dgvVenda.Rows)
            {
                ...
                itens.Parameters.AddWithValue("@quantidade", SqlDbType.Int).Value = Convert.ToInt32(dr.Cells[0].Value);
        ...
        private void btnFinalizarVenda_Click(object sender, EventArgs e)
        {
            ...
            con.Close();
            MessageBox.Show("Venda realizada com sucesso!", "Venda Concluida", MessageBoxButtons.OK, MessageBoxIcon.Information);
            dgvVenda.Columns.Clear();
            dgvVenda.Rows.Clear();
            txtTotal.Text = "";
        }
